    ...
    <div>
        <div class="jumbotron mt-2">
            ...
            <div class="justify-content-start">
                ...
                <a class="btn btn-secondary btn-sm mr-1" href="/ticket-type/1/ticket/crear" role="button">
                    <i class="fas fa-fw fa-ticket-alt"></i>
                    Nuevo Ticket
                </a>
                <a v-if="user_role == 1" class="btn btn-secondary btn-sm mr-1" href="/ticket-type/2/ticket/crear">
                    <i class="fas fa-fw fa-tools"></i>
                    Nuevo Parte de Trabajo
                </a>
                <a v-if="user_role == 1" class="btn btn-secondary btn-sm mr-1" href="/customer">
                    <i class="fas fa-fw fa-building"></i>
                    Lista Clientes
                </a>
                <a v-if="user_role == 1" class="btn btn-secondary btn-sm mr-1" href="/user">
            ...
            <div class="justify-content-start mt-3">
                ...
                <a class="btn btn-secondary btn-sm mr-1" href="/ticket" role="button">
                    <i class="fas fa-fw fa-list"></i>
                    Todos los tickets
                </a>
                <a class="btn btn-outline-dark btn-sm mr-1" href="/ticket?ticket-status=1" role="button">
                    <i class="fas fa-fw fa-envelope"></i>
                    Nuevo(s)
                </a>
                <a class="btn btn-outline-info btn-sm mr-1" href="/ticket?ticket-status=2" role="button">
                    <i class="fas fa-fw fa-envelope-open"></i>
                    Abierto(s)
                </a>
                <a class="btn btn-outline-success btn-sm mr-1" href="/ticket?ticket-status=3" role="button">
                    <i class="fas fa-fw fa-check-square"></i>
                    Resuelto(s)
                </a>
                <a class="btn btn-outline-danger btn-sm mr-1" href="/ticket?ticket-status=4" role="button">
...
export default {
    ...
    async mounted(){
        ...
        if(this.user_role == 3)
        {
            axios.get('/api/get_customer_charts').then((res) => {
                this.weeklyTickets = res.data.last_week_tickets;
                this.ticketStatuses = res.data.ticket_statuses;
            }).finally( () =>{
